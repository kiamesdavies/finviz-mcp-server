...
# Subtheme filter values (Finviz Elite thematic screening)
# Format: subtheme_{themename} in URL filter
SUBTHEME_VALUES = {
    # Agriculture
    'agriculturealtprotein', 'agriculturecropinputs', 'agricultureindoorfarming',
    'agricultureprocessing', 'agriculturesmartfarming',
    # AI
    'aiadssearch', 'aiagi', 'aiapplications', 'aicloud', 'aicompute', 'aidata',
    'aiedge', 'aienergy', 'aienterprise', 'aimodels', 'ainetworking', 'airobotics', 'aisecurity',
    # Automation
    'automationautomation', 'automationdprinting', 'automationiot', 'automationlogistics',
    'automationmachinevision', 'automationrobotics', 'automationsoftware',
    # Autonomous
    'autonomousavmobility', 'autonomousdefense', 'autonomousindustrial',
    'autonomousmachinevision', 'autonomoussoftware', 'autonomousspecialized',
    # Big Data
    'bigdataaiplatforms', 'bigdataanalyticsbi', 'bigdatainfrastructure', 'bigdataproviders',
    # Biometrics
    'biometricsgovdefense', 'biometricshardware', 'biometricsidentity', 'biometricssoftware',
    # Blockchain
    'blockchainenterprise', 'blockchaininfrastructure', 'blockchainmining',
    'blockchainpayments', 'blockchainplatforms', 'blockchaintokenization',
    # Cloud
    'clouddatabases', 'clouddatacenters', 'clouddevops', 'cloudedge', 'cloudhardware',
    'cloudhsaas', 'cloudhybridcloud', 'cloudhyperscalers', 'cloudmulticloud',
    'cloudpaas', 'cloudsecurity', 'cloudserverless',
    # Commodities Agriculture
    'commagribiofuels', 'commagrifertilizers', 'commagrigrains', 'commagrilivestock', 'commagrisofts',
    # Commodities Energy
    'commenergybiofuels', 'commenergygaslng', 'commenergyoil', 'commenergyuranium',
    # Commodities Metals
    'commmetalsbattery', 'commmetalsgold', 'commmetalsindustrial', 'commmetalsprecious',
    'commmetalsrareearth', 'commmetalsrecycling', 'commmetalssilver',
    # Consumer
    'consumerapparel', 'consumerfarmdirect', 'consumerfood', 'consumerhousehold',
    'consumerluxury', 'consumersecondhand',
    # Cybersecurity
    'cybersecurityappsecurity', 'cybersecuritycloud', 'cybersecurityendpoint',
    'cybersecurityidentityiam', 'cybersecuritynetwork', 'cybersecuritysiem',
    'cybersecuritythreatops', 'cybersecurityzerotrust',
    # Defense
    'defenseaviation', 'defensecyberdefense', 'defensedrones', 'defensemanufacturing',
    'defensemissiles', 'defensespacetech', 'defenseweapons',
    # Ecommerce
    'ecommerceadsmedia', 'ecommercedtc', 'ecommercegrocery', 'ecommercelogistics',
    'ecommercemarketplaces', 'ecommerceomnichannel', 'ecommerceplatforms',
    'ecommercesecondhand', 'ecommercesocial',
    # Education
    'educationcurriculum', 'educationinfrastructure', 'educationplatforms', 'educationworkforce',
    # Energy Base
    'energybasemajors', 'energybasenuclear', 'energybaseoilproduction',
    'energybaseoilrefining', 'energybaseoilservices', 'energybasethermal', 'energybaseutilities',
    # Energy Clean
    'energycleanbatteries', 'energycleanbiofuels', 'energycleangeothermal', 'energycleanhydrogen',
    'energycleanmaterials', 'energycleansmartgrid', 'energycleansolar',
    'energycleanutilities', 'energycleanwind',
    # Entertainment
    'entertainmentbetting', 'entertainmentgambling', 'entertainmentgaming',
    'entertainmentinfrastructure', 'entertainmentmusic', 'entertainmentvideo',
    # Environmental
    'environmentalagriculture', 'environmentalairquality', 'environmentalclimate',
    'environmentalwaste', 'environmentalwater',
    # EVs
    'evsbatteries', 'evscharging', 'evschips', 'evsfleets', 'evsmanufacturers',
    'evsselfdriving', 'evssuppliers',
    # Fintech
    'fintechblockchain', 'fintechexchanges', 'fintechinsurance', 'fintechlending',
    'fintechneobanks', 'fintechpayments', 'fintechtrading',
    # Hardware
    'hardwaredatacenters', 'hardwareelectronics', 'hardwaregaming', 'hardwareindustrialiot',
    'hardwarenetworking', 'hardwarenextgen', 'hardwarepcsdevices', 'hardwareprinting',
    'hardwareservers', 'hardwarestorage', 'hardwaretelecom',
    # Healthcare
    'healthcaredevices', 'healthcarediagnostics', 'healthcaregenomics', 'healthcareitdata',
    'healthcaremetabolic', 'healthcarenextgen', 'healthcareoncology',
    'healthcaretelemedicine', 'healthcaretherapeutics',
    # IoT
    'iotedgedevices', 'iotenterprise', 'iothardware', 'iotnetworking', 'iotsecurity', 'iotsoftware',
    # Longevity
    'longevityagingpharma', 'longevityhealthcare', 'longevityhealthyaging', 'longevityseniorliving',
    # Nanotech
    'nanotechelectronics', 'nanotechenergy', 'nanotechmaterials', 'nanotechmedicine',
    'nanotechproducts', 'nanotechresearchtools',
    # Nutrition
    'nutritionaltprotein', 'nutritionmealdelivery', 'nutritionretailers', 'nutritionsupplements',
    # Quantum
    'quantumapplications', 'quantumcloud', 'quantumenablingtech', 'quantumhardware',
    'quantumnetworking', 'quantumsoftware',
    # Real Estate
    'realestatehealthcare', 'realestatehousing', 'realestateittelecom', 'realestateoffice',
    'realestateretail', 'realestatetourism', 'realestatewarehousing',
    # Robotics
    'roboticsautomation', 'roboticsavmobility', 'roboticsconsumer', 'roboticslogistics',
    'roboticsmachinevision', 'roboticsmedical',
    # Semiconductors
    'semisanalog', 'semiscompute', 'semisdesigntools', 'semisfoundries', 'semislithography',
    'semismemory', 'semisnextgen', 'semispackaging', 'semiswireless',
    # Smart Home
    'smarthomeautomation', 'smarthomedevices', 'smarthomeenergy', 'smarthomenetworking',
    'smarthomesecurity', 'smarthomevoiceai',
    # Social
    'socialadvertising', 'socialgaming', 'socialnetworks', 'socialniche', 'socialvisualcontent',
    # Software
    'softwarecollaboration', 'softwarecrm', 'softwaredataanalytics', 'softwaredesign',
    'softwaredevops', 'softwareecommerce', 'softwareenterprise', 'softwaregaming',
    'softwarehsaas', 'softwareos', 'softwaresecurity', 'softwarevsaas',
    # Space
    'spacedataanalytics', 'spacedefense', 'spaceinfrastructure', 'spacelaunch', 'spacesatellites',
    # Telecom
    'telecomcloudedge', 'telecomenterprise', 'telecomg', 'telecominfrastructure',
    'telecomsatcom', 'telecomwireless',
    # Transportation
    'transportationaircargo', 'transportationairtravel', 'transportationinfrastructure',
    'transportationmaritime', 'transportationnextgen', 'transportationrail',
    'transportationtrucking', 'transportationwarehousing',
    # VR/AR
    'varealityapplications', 'varealityenterprise', 'varealityhardware',
    'varealityinfrastructure', 'varealitysoftware',
    # Wearables
    'wearablesimmersive', 'wearablesmedical', 'wearablessmartwatches',
    'wearablessoftware', 'wearablessport',
}

# Legacy mappings for backward compatibility
MARKET_CAP_FILTERS = list(MARKET_CAP_VALUES.keys())

# Finviz comprehensive field mapping constants (by column index)
FINVIZ_COMPREHENSIVE_FIELD_MAPPING = {
    ...
    # Financial/Earnings-related (30-39)
    ...
    # ETF and other additional fields (110-125)
...
def _normalize_csv_field_name(name: str) -> str:
    """Normalize a CSV header to the snake_case key used in export parsing."""
    return (
        name.lower()
        .replace(' ', '_')
        .replace('/', '_')
...
# Map normalized CSV header -> canonical mapping key
FINVIZ_FIELD_ALIASES = {}

# Map canonical mapping key -> normalized CSV header
FINVIZ_CANONICAL_TO_NORMALIZED = {}

for _key, _info in FINVIZ_COMPREHENSIVE_FIELD_MAPPING.items():
    _csv_name = _info.get('csv_name')
    if not _csv_name:
        continue
    _normalized = _normalize_csv_field_name(_csv_name)
    FINVIZ_CANONICAL_TO_NORMALIZED[_key] = _normalized
    if _normalized != _key and _normalized not in FINVIZ_FIELD_ALIASES:
        FINVIZ_FIELD_ALIASES[_normalized] = _key

# CSV export parameters to retrieve all columns (updated)
